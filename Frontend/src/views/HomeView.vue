    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100 h-60"
            src="https://file.hstatic.net/1000381168/collection/web-3_7d7345db617845e3a434d730f95ea6d9.png"
            alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100"
            src="https://file.hstatic.net/1000381168/collection/kc-gia_554e959de61f48c7870af62028ee572e.png"
            alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100"
            src="https://file.hstatic.net/1000381168/file/slide-4_39c1b3b42ede456face3e40e1cb58218.png" alt="Third slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100"
            src="https://file.hstatic.net/1000381168/file/slide-3_6c1af2f5981a4ddfb31d32196d470640.png" alt="Four slide">
        </div>
      </div>
